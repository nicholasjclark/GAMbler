...
```{r, fig.width = 6, fig.height = 6, fig.align='center',fig.alt = "Histograms of intercept parameter estimates when considering or ignoring detection error."}
...
```{r, fig.width = 6, fig.height = 6, fig.align='center',fig.alt = "Histograms of coefficient parameter estimates when considering or ignoring detection error."}
...
```{r, fig.width = 6, fig.height = 6, fig.align='center',fig.alt = "Recovering diagnostic sensitivity and specificity using detection error models."}
layout(matrix(1:2, ncol = 1))
par(mar = c(4, 1, 1.5, 1))
...
```{r, fig.width = 6, fig.height = 6, fig.align='center',fig.alt = "Estimating true disease burden using detection error models in Stan."}
