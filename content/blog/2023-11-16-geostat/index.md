...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-16-1.png" alt="Simulating spatially autocorrelated data in R using a Gaussian Process" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-17-1.png" alt="Simulating spatially autocorrelated count data in R using a Gaussian Process" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-22-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-23-1.png" alt="Failures of regression models that do not account for inherent spatial autocorrelation" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-24-1.png" alt="Failures of regression models that do not account for inherent spatial autocorrelation" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-25-1.png" alt="Failures of regression models that do not account for inherent spatial autocorrelation" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-26-1.png" alt="Failures of regression models that do not account for inherent spatial autocorrelation" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-32-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-33-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-34-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-39-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-40-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-41-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-46-1.png" alt="Visualising spatial autocorrelation kernels fitted with the Stan geostatistical model" width="576" style="display: block; margin: auto;" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-53-1.png" alt="Stan geostatistical model predictions show adequate fit to the simulated data in R" width="576" style="display: block; margin: auto;" />
